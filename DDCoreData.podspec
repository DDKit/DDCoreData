#
# Be sure to run `pod lib lint DDCoreData.podspec' to ensure this is a
...
DESC
  ...
  s.swift_version = '4.2'
  s.source_files = 'DDCoreData/Classes/**/*'
  
  # s.resource_bundles = {
  #   'DDCoreData' => ['DDCoreData/Assets/*.png']
  # }
